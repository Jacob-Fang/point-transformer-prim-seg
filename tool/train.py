...
def get_parser():
    ...
    parser.add_argument('--config', type=str, default='config/ABCdataset/ABC_pointtransformer_repro.yaml', help='config file')
    parser.add_argument('opts', help='see config/ABCdataset/ABC_pointtransformer_repro.yaml for all options', default=None, nargs=argparse.REMAINDER)
