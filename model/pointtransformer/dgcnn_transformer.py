...
class PointTransformer_Encoder(nn.Module):
    ...
    def __init__(self, input_channels=6, args=None):
        ...
        self.in_mlp = nn.Sequential(
            nn.Conv1d(input_channels, self.planes[0], kernel_size=1, bias=False),
        ...
        self.PtBlock1 = PointTransformerBlock(in_channels=self.planes[0])
        self.PtBlock2 = PointTransformerBlock(in_channels=self.planes[0])
        self.PtBlock3 = PointTransformerBlock(in_channels=self.planes[0], out_channels=self.planes[1])
    ...
    def forward(self, pc):
        ...
        p1, x1 = self.PtBlock1([p1, x1])
        p2, x2 = self.PtBlock2([p1, x1])
        p3, x3 = self.PtBlock3([p2, x2])
...
class PointTransformer_PrimSeg(nn.Module):
    ...
    def __init__(self, c=6, emb_size=128, num_primitives=10, primitives=True, embedding=True, param=True, mode=5, num_channels=6, nn_nb=80, args=None):
    ...
    def forward(self, pc):
        ...
        x, first_layer_features = self.encoder(pc)
